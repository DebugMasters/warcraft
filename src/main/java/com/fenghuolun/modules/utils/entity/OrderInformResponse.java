...
public class OrderInformResponse {
	...
	public void write(Document document) {
		...
		Element returnCodeElement = document.createElement("return_code");
		returnCodeElement.setTextContent(return_code);
		Element returnMsgElement = document.createElement("return_msg");
		returnMsgElement.setTextContent(return_msg);
		root.appendChild(returnCodeElement);
		root.appendChild(returnMsgElement);
